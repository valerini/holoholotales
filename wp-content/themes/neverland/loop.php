<?php
$featured_image = '<a href="' . get_permalink() . '"><img class="tac" src="' . aq_resize(wp_get_attachment_url(get_post_thumbnail_id()), 1170, 705, true, true, true) . '" alt=""></a>';
    ...
    echo '
		<div class="post_content">
			...
			' . apply_filters("the_content", to_excerpt(strip_shortcodes(get_the_content()), 50)) . '
			</div>
			<div class="post_meta">
