<?php
$featured_image = '<a href="' . get_permalink() . '"><img class="tac" src="' . aq_resize(wp_get_attachment_url(get_post_thumbnail_id()), 1170, 1170/*880*/, true, true, true) . '" alt=""></a>';
